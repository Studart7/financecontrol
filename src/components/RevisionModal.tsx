...
export const RevisionModal: React.FC<RevisionModalProps> = ({ isOpen, onClose, onSave, initialData }) => {
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-surface-dim/80 backdrop-blur-sm">
        ...
        >
          ...
          <p className="text-sm text-secondary mb-6">A Inteligência Artificial extraiu os seguintes dados da nota. Verifique e edite se necessário antes de salvar.</p>
